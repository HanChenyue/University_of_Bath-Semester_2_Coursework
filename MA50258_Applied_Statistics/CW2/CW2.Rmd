...
$$
\begin{array}{rcl}
E(\text{Infant Mortality Rate | Years of Education, GDP, Life Expectancy}) &=& \exp(\beta_0 + \beta_1 \times \text{Years of Education} + \beta_2 \times \text{log(GDP)} + \beta_3 \times \text{Life Expectancy}\\
&& + \beta_4 \times \text{Years of Education} \times \text{log(GDP)}\\
&& + \beta_5 \times \text{Years of Education} \times \text{Life Expectancy}\\
&& + \beta_6 \times \text{log(GDP)} \times \text{Life Expectancy}\\
&& + \beta_7 \times \text{Years of Education} \times \text{log(GDP)} \times \text{Life Expectancy})
\end{array}
$$
