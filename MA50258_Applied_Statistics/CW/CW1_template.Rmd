...
Based on the graph, when `q1` < 100s, the theoretical time is faster than the actual time. However, when `q1` > 100s, the actual time is faster than the theoretical time. 
