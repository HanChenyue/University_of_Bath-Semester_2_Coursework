...
# Add the decile information to the formula_tom_no_na_q4 dataframe
pred_grid <- 
...
ggplot(
  aes(x = q1_in_seconds + log10_championship_points + q1_in_seconds*log10_championship_points,
      y = q3_in_seconds)) +
  geom_point(alpha = 0.25)# +
  # geom_line(aes(x = q1_in_seconds + log10_championship_points + q1_in_seconds*log10_championship_points, y = q3_in_seconds, data = pred_grid))
```
