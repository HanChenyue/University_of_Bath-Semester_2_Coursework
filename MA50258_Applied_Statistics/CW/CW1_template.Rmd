...
# Save missing_q3_data to a csv file
# write.csv(missing_q3_data, "missing_q3_data.csv")
...
formula_tom_q6 <- cbind(formula_tom_q6, qmin)

ggplot(
  formula_tom_q6,
  aes(x = q1_in_seconds, y = qmin)) +
  geom_point(alpha = 0.25)
  # geom_smooth(aes(col = "LOESS Smoothing"), method = "loess", se = F, linewidth = 0.5) +
  # geom_smooth(aes(col = "Linear Model Fit"), method = "lm", se = F, linewidth = 0.5) +
  # labs(
  #   title = "Scatterplot of q1 Against qmin",
  #   x = "Fastest Lap Time From The 1st Qualifying Session (q1)",
  #   y = "Minimum Lap Time Across q1, q2, and q3 (qmin)",
  #   subtitle = "Excluded missing data"
  # ) +
  # theme(legend.position = "bottom") +
  # scale_color_manual(
