...
# mid_decile_points <- quantile(formula_tom_no_na_q4_log10_championship_points, probs = seq(0, 2.75, by = 1)/3)
mid_decile_points <- quantile(formula_tom_no_na_q4_log10_championship_points, probs = seq(0, 1, by = 0.05))#/3)
kable(mid_decile_points, caption = "Mid-Decile Points", align = "c")
# mid_decile_points <- quantile(formula_tom_no_na_q4_log10_championship_points, probs = seq(1, 19, by = 2)/20)
# mid_decile_points <- signif(mid_decile_points, digits = 2)
