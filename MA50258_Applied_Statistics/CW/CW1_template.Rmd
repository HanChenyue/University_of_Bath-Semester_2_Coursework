...
ggplot(
  ...
  scale_colour_gradient2(
    ...
    mid = "green",
    high = "red",
    midpoint = median(max(formula_test$championship_points)/2, na.rm = TRUE)
  ) +
  scale_x_continuous(labels = function(x) paste0(x, "s")) +
  scale_y_continuous(labels = function(y) paste0(y, "s"))
...
# Transform championship_points_in_log10 to discrete deciles from 0 to 2.7
formula_tom_no_na_q4 <- formula_tom_no_na_q4 %>% mutate(
  championship_points_in_log10 = championship_points_in_log10,
  championship_points_in_log10_bin = cut(
    championship_points_in_log10,
    br
  )
)
...
formula_tom_no_na_q4 <- formula_tom_no_na_q4 %>%
  mutate(log10_championship_points_bin = cut(
    log10_championship_points,
