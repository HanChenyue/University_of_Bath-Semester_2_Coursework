...
- Without Block Effects (Part C): Only the variety effect was tested, and it showed significance but with a larger residual variance, because some of the variations due to the place effect have been unaccounted for.
...
The chi-square test statistics (Without Yates' correction) is 17.74, and the p-value is about 2.5e-05.
...
Adjusting for smoking suggests that the relationship between presence of X12
...
behaviours, lifestyle factors, access to healthcare, adherence to treatments, and
...
Chi-square statistic (Without Yates' correction): 12.89
