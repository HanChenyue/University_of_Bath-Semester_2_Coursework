...
The F-statistics obtained here will lead us to its associated p-value, which will help us determine the significance
...
# Mantel-Haenszel Odds Ratio from previous calculation
MH_OR <- 1.87
...
The overall adjusted odds ratio of 1.87 suggests that individuals prescribed X12 to those not prescribed X12 have about 1.87 times the odds of dying from CRD compared to those who survived, after adjusting for smoking status. This indicates a significant association between X12 prescription and CRD mortality across both smokers and non-smokers, with the effect being evident even after controlling for the potential confounding effect of smoking.
...
interval ranging from 1.36 to 2.57. This odds ratio, though very similar
