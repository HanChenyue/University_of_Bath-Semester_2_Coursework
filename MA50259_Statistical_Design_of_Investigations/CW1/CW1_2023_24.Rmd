...
nrep <- 4 # number of replicates
lengths <- factor(c(5, 6))
widths <- factor(c(5.5, 6.5))

# Creating the randomised experimental design
design <- expand.grid(lengths, widths)
randomised_design <- sample(, 5, replace = FALSE)
