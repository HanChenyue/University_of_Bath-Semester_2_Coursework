...
i.  The errors $\epsilon_{ijk}$ are independent and identically
    distributed $N(0,\sigma^2)$.

ii. The errors $\epsilon_{ijk}$ are independent of the treatment effects
    $\tau_{i}$.

iii. The errors $\epsilon_{ijk}$ are independent of one another.

iv. The errors $\epsilon_{ijk}$ are normally distributed.

v.  The errors $\epsilon_{ijk}$ have constant variance $\sigma^2$.

The first four assumptions are justified because the experimental design
is a completely randomised design (CRD) and the errors $\epsilon_{ijk}$
