...
Given that we obtained a p-value of $3.33 \times 10^-16$, which is less than the significance level of 0.05 (*5% is commonly used in a typical hypothesis test*), we reject the null hypothesis and conclude that there is a treatment effect.
...
Let $c_0 = 0$ as we are only interested to check for presence of a linear trend due to varying the amount of baking powder used.
